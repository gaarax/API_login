...
/**
 * This is the model class for table "userr".
 *
 * @property integer $id
 ...
 * @property Userr[] $users
 * @property Userr[] $friendUsers
 ...
 */
class Userr extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Userr::className(), ['id' => 'user_id'])->viaTable('user_friendship', ['friend_user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Userr::className(), ['id' => 'friend_user_id'])->viaTable('user_friendship', ['user_id' => 'id']);
    }
